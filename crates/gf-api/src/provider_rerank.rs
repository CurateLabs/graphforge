...
pub struct ProviderRerankPlanInspection {
    ...
    pub token_count_class: gf_storage::TokenCountClass,
    ...
    pub chunking: Option<gf_storage::ChunkingIdentity>,
...
impl From<gf_search::ProviderError> for ProviderRerankError {
...
impl GraphForge {
        ...
        F: FnMut(&ProviderModelContract, &str) -> ProviderResult<u64>,
    {
        ...
        let runtime = gf_search::StandardProviderExecutionRuntime::new();
    ...
    pub fn rerank_find_results(
        ...
        if provider.contract() != &request.contract {
            return Err(gf_search::ProviderError::new(
                &request.contract,
...
fn exhausted(contract: &ProviderModelContract) -> ProviderRerankError {
    gf_search::ProviderError::new(contract, ProviderFailureClass::ResourceExhausted).into()
}
...
mod tests {
    ...
    fn execute(
        ...
        let mut estimate_cost =
            |shape: gf_search::RerankWorkShape| Ok(u64::try_from(shape.candidates()).unwrap());
    ...
    fn detailed_find_keeps_omission_neutral_and_reranks_explicitly() {
        ...
        let mut estimate_cost = |shape: gf_search::RerankWorkShape| Ok(shape.candidates() as u64);
    ...
    fn inspection_is_payload_free_and_execution_reorders_canonical_arrow() {
        ...
        assert_eq!(inspection.provider, gf_search::DEFAULT_REMOTE_PROVIDER);
