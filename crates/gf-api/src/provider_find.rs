        ...
        with_artifact_checkpoint(&self.contract, self.checkpoint, |guarded| {
            self.controller
                .execute(work, self.runtime, guarded, &mut |attempt_checkpoint| {
                    ...
                    .map(gf_search::ValidatedQueryEmbedding::into_vector)
                })
        })
    }
}
...
impl GraphForge {
    ...
    pub fn configure_provider_find_runtime(
        ...
        configured
            .contract()
            .require(gf_search::ProviderCapability::QueryEmbeddings)
...
fn validate_read_decision(
    prepared: &gf_search::PreparedEmbeddingRead,
...
fn validate_contract(
    ...
    tokenizer: Option<&gf_storage::TokenizerIdentity>,
    chunking: Option<&gf_storage::ChunkingIdentity>,
    contract: &ProviderModelContract,
    ...
    contract.require(gf_search::ProviderCapability::QueryEmbeddings)?;
...
mod tests {
    ...
    fn provider_request(
        ...
        ProviderEmbeddingPlanRequest {
            ...
            batch_limits: gf_search::ProviderBatchLimits::default(),
    ...
    fn publish_provider_space_as(
        ...
        let mut estimate_cost = |_: gf_search::ProviderBatchShape| Ok(0);
