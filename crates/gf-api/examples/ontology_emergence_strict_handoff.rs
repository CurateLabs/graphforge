...
fn main() {
    ...
    assert_eq!(source.ontology_mode(), gf_api::OntologyMode::Exploratory);
    ...
    source
        ...
        .unwrap();
    assert_eq!(source.ontology_mode(), gf_api::OntologyMode::Advisory);
    ...
    assert_eq!(
        ...
        gf_api::OntologyMode::Exploratory,
    ...
    target
        ...
        .unwrap();
    assert_eq!(target.ontology_mode(), gf_api::OntologyMode::Strict);
    assert_eq!(
        target.workspace_ontology().unwrap().mode,
        gf_storage::WorkspaceOntologyMode::Strict
    );
