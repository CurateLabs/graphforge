//! Cypher date, time, datetime, and duration construction and arithmetic.
//!
//! Literal and map forms share these helpers with expression lowering and runtime
//! adapters. Wide calendar operations use the range-complete calendar module;
//! named zones preserve offset/DST semantics. Duration normalization, parsing,
//! rendering, and arithmetic live in the private duration module.

mod duration;
pub use duration::{
    BetweenMode, BetweenOperand, DurationValue, date_plus_duration, datetime_plus_duration,
    duration_between, duration_component, duration_value_from_map, duration_value_from_str,
    is_duration_accessor, localtime_plus_duration, render_duration, render_duration_value,
    scale_duration,
};
use duration::{build_duration_map, format_duration};
#[cfg(test)]
mod test_support;
...
#[cfg(test)]
mod tests {
    use super::test_support::{fields, int};
    use super::*;
