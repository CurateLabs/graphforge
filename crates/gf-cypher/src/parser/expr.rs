...
mod tests {
    ...
    fn anonymous_filtered_pattern_comprehension() {
        ...
        let gf_ast::PathElement::Rel(rel) = &pattern.elements[1] else {
    ...
    fn full_existential_subquery_parses_read_pipeline() {
        ...
        assert!(matches!(query.clauses[0], gf_ast::AstClause::Match(_)));
        assert!(matches!(query.clauses[1], gf_ast::AstClause::With(_)));
        assert!(matches!(query.clauses[2], gf_ast::AstClause::Return(_)));
    }
