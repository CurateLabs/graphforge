...
pub use gf_ast::{AstQuery, ParseError, ParseErrorKind, Token};
pub use gf_core::{ExplainStage, GfError, Span};
pub use gf_ir::{Binder, OntologyMode, RuntimeCatalog};
...
/// - `GraphIR\n-------\n<JSON>` — serialised [`gf_ir::GraphPlan`] produced by the
...
/// - [`ExplainStage::GraphIr`] — serialised [`gf_ir::GraphPlan`] (binder runs in
...
fn bind_exploratory(ast: &AstQuery) -> Result<gf_ir::GraphPlan, GfError> {
