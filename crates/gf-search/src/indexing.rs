...
use gf_storage::{SearchArtifactError, SearchPublicationMode, SearchPublicationOutcome};
...
mod tests {
    ...
    use gf_ir::{IrLiteral, OntologyMode, TypeId};
    use gf_storage::{GraphWriter, SearchPublicationOutcome, generation::bump_search_generation};
