...
///
/// Defined in [`gf_core`] (shared with the project manifest) and re-exported
/// here so existing `gf_ir::OntologyMode` paths keep resolving.
pub use gf_core::OntologyMode;
...
///
/// ```
/// use gf_ir::{GraphPlan, GraphOp, VarId};
///
