...
use graphforge_storage::adjacency::{
    ...
    adjacency_relation_key, is_adjacency_relation_key,
};
...
impl PersistentAdjacencyProvider {
    ...
    pub fn new(dir: PathBuf, _mode: OntologyMode) -> Self {
        Self::with_artifact_dir(dir.clone(), dir)
    }
    ...
    pub fn new_with_cache(dir: PathBuf, cache_root: &std::path::Path, _mode: OntologyMode) -> Self {
        ...
        Self::with_artifact_dir(dir, artifact_dir)
    }

    fn with_artifact_dir(dir: PathBuf, artifact_dir: PathBuf) -> Self {
    ...
    fn state(&self) -> IndexState {
        ...
        let artifact_dir = self
            ...
            .clone();
        guard
            .get_or_insert_with(|| Self::read_state(&self.dir, &artifact_dir))
            .clone()
    }

    fn read_state(source_dir: &std::path::Path, artifact_dir: &std::path::Path) -> IndexState {
