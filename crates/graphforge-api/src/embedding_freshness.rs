...
use graphforge_search::{EmbeddingReadLimits, PreparedEmbeddingRead, prepare_embedding_read};
...
fn current_source(
    ...
    publication: &graphforge_storage::EmbeddingGenerationPublication,
    ...
    .transpose()?
    .map(graphforge_storage::EmbeddingMutationObservation::current_source);
...
mod tests {
    ...
    fn publish(
        graph: &GraphForge,
        count: u8,
    ) -> graphforge_storage::EmbeddingGenerationPublication {
