...
impl From<graphforge_search::ProviderError> for ProviderEmbeddingPlanError {
                ...
                match checkpoint() {
                    ...
                    Err(error) => {
                        ...
                        Err(graphforge_search::ProviderError::new(
                            &request.contract,
                            graphforge_search::ProviderFailureClass::Cancelled,
                        ))
                    }
                }
            });
    ...
    C: FnMut() -> Result<(), SearchArtifactError> + ?Sized,
{
    ...
    capture_embedding_source(
        ...
        graphforge_search::EmbeddingSourceCaptureLimits::default(),
        checkpoint,
    )
    .map_err(Into::into)
}
...
mod tests {
    ...
    use graphforge_search::{ProviderCapabilities, ProviderFailureClass};
