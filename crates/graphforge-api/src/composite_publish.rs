...
mod rebase;
use property_routes::{
    CompositePropertyRoutes, composite_created_owner, composite_node_property_owner,
    validate_composite_property_routes,
};
pub(crate) use rebase::administrative_contract;
...
mod tests {
    ...
    pub(super) fn publish_request() -> CompositeTransactionRequest {
