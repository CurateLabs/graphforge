...
class GraphForge:
    ...
    def submit_research_proposal(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> dict[str, Any]: ...
    def preview_research_proposal(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> pyarrow.Table: ...
    def review_research_proposal(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> dict[str, Any]: ...
    def release_research_proposal(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> dict[str, Any]: ...
    ...
    def research_proposal_history(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> pyarrow.Table: ...
    def preview_research_upstream(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> pyarrow.Table: ...
    def update_research_branch(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> dict[str, Any]: ...
    def research_upstream_history(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> pyarrow.Table: ...
    ...
    def relate_research_claims(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> pyarrow.Table: ...
    def record_research_decisions(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> pyarrow.Table: ...
    def change_research_branch_claim(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> dict[str, Any]: ...
    def inspect_research_claims(self, request: dict[str, Any]) -> pyarrow.Table: ...
    def research_claim_history(self, request: dict[str, Any]) -> pyarrow.Table: ...
    def research_decision_history(self, request: dict[str, Any]) -> pyarrow.Table: ...
    def research_canonical_choices(self, request: dict[str, Any]) -> pyarrow.Table: ...
    ...
    def restore_research_branch(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> dict[str, Any]: ...
    def change_research_branch_ontology(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> dict[str, Any]: ...
    def reference_research_branch(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> dict[str, Any]: ...
    def bring_research_branch(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> dict[str, Any]: ...
    def suppress_research_branch_assertion(
        self, request: dict[str, Any], *, cancellation: CancellationToken | None = None
    ) -> dict[str, Any]: ...
    def research_branch(self, branch_uuid: str) -> dict[str, Any]: ...
    def research_branch_fields(self, branch_uuid: str) -> pyarrow.Table: ...
    def research_branch_references(self, branch_uuid: str) -> pyarrow.Table: ...
    def research_branch_selection(self, branch_uuid: str) -> pyarrow.Table: ...
    def query_research_branch(self, branch_uuid: str, query: str) -> pyarrow.Table: ...
    ...
    def research_version(self, version_uuid: str) -> dict[str, Any]: ...
    def list_research_versions(self) -> pyarrow.Table: ...
    def research_version_retention(self) -> dict[str, Any]: ...
    def query_research_version(self, version_uuid: str, query: str) -> pyarrow.Table: ...
    def research_version_artifact(self, version_uuid: str, artifact_uuid: str) -> pyarrow.Table: ...
    def research_version_artifact_payload(
        self, version_uuid: str, artifact_uuid: str
    ) -> pyarrow.Table: ...
    def research_version_ontology(self, version_uuid: str) -> dict[str, Any]: ...
    def research_version_metadata(self, version_uuid: str) -> dict[str, Any]: ...
