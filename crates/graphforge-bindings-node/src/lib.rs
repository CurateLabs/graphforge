...
fn ontology_mode(value: &str) -> Result<graphforge_api::OntologyMode> {
    match value {
...
fn adjacency_inspection_to_json(
...
fn parse_algorithm_id(value: &str) -> Result<graphforge_api::Algorithm> {
    let (verb, name) = value
        .split_once('.')
