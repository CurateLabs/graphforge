...
//!
//! Callers mint UUIDv7 identifiers (via [`gf_core::uuid::new_v7`]) and feed
...
use gf_core::uuid::{Uuid, to_bytes};
...
fn literal_to_string(lit: &IrLiteral) -> String {
    match lit {
        ...
        // months/days/seconds/nanos form (the canonical `P…` render lives in gf-rel).
        IrLiteral::Duration {
            months,
            days,
            seconds,
        ...
        // (the canonical renders live in gf-rel).
