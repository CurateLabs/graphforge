...
use gf_ontology::ontology::{PropertyDef, PropertyValueType};
...
/// the single source of truth shared by storage and the gf-rel query value.
...
/// chronologically. The single source of truth shared by storage and gf-rel. (#1011)
#[must_use]
...
/// (#1011). The single source of truth shared by storage and the gf-rel value.
#[must_use]
...
/// (ADR 0009/0012). Shared by storage and gf-rel.
#[must_use]
...
mod tests {
    use super::*;
    use gf_ontology::ontology::PropertyValueType;
    ...
    fn property_schema_roundtrip() {
        use gf_ontology::ontology::PropertyDef;
        let defs = vec![
            PropertyDef {
                owner: "Person".into(),
                name: "name".into(),
