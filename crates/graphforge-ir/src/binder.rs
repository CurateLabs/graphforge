...
impl Binder {
    ...
    fn lower_match(&self, m: &graphforge_ast::MatchClause, optional: bool, s: &mut BinderState) {
        if optional {
    ...
    fn lower_merge(&self, m: &graphforge_ast::MergeClause, s: &mut BinderState) {
    ...
    fn lower_delete(&self, d: &graphforge_ast::DeleteClause, s: &mut BinderState) {
    ...
    fn lower_return(&self, r: &graphforge_ast::ReturnClause, s: &mut BinderState) {
...
fn lower_direction(dir: graphforge_ast::Direction) -> Direction {
    match dir {
