...
GraphForge v0.5.2 is one 26-node release: 17 crates.io crates, one PyPI
...
4. `graphforge-io`
5. `graphforge-ast`
6. `graphforge-knowledge`
7. `graphforge-ontology`
8. `graphforge-provenance`
9. `graphforge-ir`
10. `graphforge-plan`
11. `graphforge-storage`
12. `graphforge-rel`
13. `graphforge-search`
14. `graphforge-cypher`
15. `graphforge-exec`
16. `graphforge-api`
17. `graphforge-cli`
...
re-observes all three registries and produces one stable 26-node summary. Job
...
- decide any registry-specific yank/deprecation if reconciliation finds a
  conflict; and
- close the human release tracker only after the 26-node summary is complete.
