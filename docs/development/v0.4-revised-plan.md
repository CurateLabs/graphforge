> **SUPERSEDED** — This plan was for TCK compliance (achieved in v0.3.8).
> The current v0.4.0 scope is the Three-Surface API (`db.gds` + `db.search`); see `docs/releases/roadmap.md`.
...
**Issue:** (Join reordering) depends on this
...
3. **Tutorial notebook:** `examples/notebooks/v0.4_features.ipynb`
