...
| `compute_threads` | `2` | Instance-owned private CPU pool (#342 cosine KNN; #343 PageRank; #344 Node2Vec walks; #535 Jaccard similarity; #501 betweenness) |
...
Jaccard node similarity (#535), and betweenness Brandes source searches (#501) may partition independent work
...
reductions, Jaccard retains serial candidate order per source, betweenness reduces per-source dependency arrays in canonical source order,
