...
REQUIRED_EVIDENCE = {
    "same-instance": (
        "same-process",
        "crates/graphforge-api/src/same_process_concurrency_tests.rs",
    ...
    "stream-drop": (
        "cancellation",
        "crates/graphforge-api/src/stream_cancellation_isolation_tests.rs",
    ...
    "shared-read-write": (
        "shared-directory",
        "crates/graphforge-api/src/shared_directory_semantics_tests.rs",
    ...
    "killed-writer": (
        "multi-process",
        "crates/graphforge-api/src/multi_process_publication_tests.rs",
    ...
    "composite-kill-reopen": (
        "composite-recovery",
        "crates/graphforge-api/src/composite_recovery_tests.rs",
